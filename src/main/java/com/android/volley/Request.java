...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /** Sequence number of this request, used to enforce FIFO ordering.序列号 */
     ...
     * 这个地方在很多地方会有调用，主要是由于任务在线程中执行，所以在执行获取或者交付时要检测是否request被取消
     */
     ...
     * 给当前request一个已经分发response的标志，这样可以防止相同的response
     */
     ...
     * if you return null.
     * 注释很清晰明确，work thread 是指CacheDispatcher或者NetworkDispatcher
     ...
     * 传递一个非空的已经被上面的抽象方法解析好的response，没有解析的无法被分发
